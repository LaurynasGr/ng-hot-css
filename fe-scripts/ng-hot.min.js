...
(function(){var e=io.connect(),n=document.documentMode||/Edge/.test(navigator.userAgent),i=!0,t=Function.prototype.bind.call(console.log,console);e.on("css",function(e){n?t("Updating Stylesheets..."):t("%cUpdating Stylesheets...","color: #006b00"),a(e)}),e.on("compiling",function(){n?t("Compiling the App..."):t("%cCompiling the App...","color: #FF0000")}),e.on("reload",function(){n?t("Reloading Website..."):t("%cReloading Website...","color: #FF0000"),location.reload()});var c={observe:function(){},disconnect:function(){}},s={},o=function e(){c.disconnect();for(var n=document.head.getElementsByTagName("style"),t=0;t<n.length;t++)n[t].keep||n[t].parentNode.removeChild(n[t]);i?requestAnimationFrame(e):c.observe(document.head,{childList:!0})},a=function(e){c.disconnect();for(var n=0;n<e.length;n++){var t=e[n].fileName;if(!s[t]){var o=document.createElement("style");o.setAttribute("filename",t),o.keep=!0,document.head.appendChild(o),s[t]=o}s[t].innerHTML=e[n].css}i||c.observe(document.head,{childList:!0})};window.addEventListener("load",function(){setTimeout(function(){i=!1,window.MutationObserver&&(c=new MutationObserver(function(){i=!0,o(),setTimeout(function(){i=!1},250)}))},2e3)}),e.on("authenticated",function(e){n?t("Waiting for file changes..."):t("%cWaiting for file changes...","color: #006b00"),o(),a(e)});var r=new Date,d=(sessionStorage.__socketID||(sessionStorage.__socketID=JSON.stringify({id:"socket_"+r.getTime(),connectedAt:r.toLocaleString()})),JSON.parse(sessionStorage.__socketID));e.emit("login",d)})();}();